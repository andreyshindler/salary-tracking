...
ASK_NIGHT_WINDOW = (
    "🌙 באילו שעות מתחיל ומסתיים תעריף הלילה?\n"
    "שלח שתי שעות, למשל: <code>22:00 08:00</code>"
)
ASK_MANUAL = (
...
HELP = (
    ...
    "יש שני תעריפים בלבד:\n\n"
    "‏• <b>150%</b> — שעות לילה ({night}), שבת וחג\n"
    "‏• <b>100%</b> — כל השאר\n\n"
    "אורך המשמרת לא משנה את התעריף — רק השעה והתאריך קובעים. "
    "שעה שהיא גם לילה וגם שבת נשארת 150%, התוספות לא מצטברות.\n\n"
