...
WEBAPP_PROMPT = (
    "📅 <b>יומן שעות</b>\n\n"
    "לחץ על הכפתור למטה כדי לפתוח את היומן, לבחור תאריך ולגלול לשעות."
)
WEBAPP_BAD_PAYLOAD = "לא הצלחתי לקרוא את הנתונים מהיומן. נסה שוב."
WEBAPP_BAD_DATE = "התאריך שנשלח מהיומן לא סביר. נסה שוב."
KEYBOARD_REMOVED = (
    "‏🗓 <b>היומן עבר לתפריט</b>\n"
    "הכפתור הישן מתחת לשורת ההקלדה כבר לא נחוץ — לחיצה על <b>🗓 יומן</b> "
    "בתפריט פותחת את היומן ישירות."
)
...
HELP = (
    "<b>איך זה עובד</b>\n\n"
    "<b>רישום שעות</b>\n"
    "‏• 🗓 יומן — בוחרים תאריך, מגלגלים שעת התחלה וסיום, וזהו.\n"
    "‏• אפשר גם לשלוח שורה בצ׳אט: <code>16:00 21:30</code> "
    "או <code>12/09 16:00 21:30</code>.\n\n"
    "<b>איך מחושב השכר</b>\n"
